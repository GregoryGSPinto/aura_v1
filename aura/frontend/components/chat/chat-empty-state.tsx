        ...
        <div className="mt-6 grid gap-2 sm:grid-cols-2">
          {quickPrompts.map((prompt) => (
            <button
              ...
              className="rounded-lg border border-white/5 bg-zinc-900/50 px-3 py-3 text-left text-sm text-zinc-400 transition hover:border-white/10 hover:bg-zinc-900 hover:text-zinc-300"
            >
              {prompt}
            </button>
          ))}
