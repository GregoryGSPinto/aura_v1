  ...
  return (
    <>
      <nav className="mobile-bottom-nav lg:hidden">
        <div className="glass-strong mx-auto flex w-[calc(100%-1rem)] max-w-md items-center justify-between rounded-xl border border-white/5 px-3 py-2 shadow-[0_-12px_40px_rgba(0,0,0,0.45)]">
      ...
      <AnimatePresence>
        {menuOpen && (
          <>
            ...
            >
              <div className="glass-strong overflow-hidden rounded-xl border border-white/5 shadow-[0_-24px_80px_rgba(0,0,0,0.55)]">
                  ...
                  {menuItems.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        onClick={() => setMenuOpen(false)}
                        className={cn(
                          'flex items-center gap-3 rounded-lg px-4 py-3.5 transition-all',
                          isActive
